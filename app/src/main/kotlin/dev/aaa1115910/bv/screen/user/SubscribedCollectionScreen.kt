...
private class SubscribedCollectionQueryState {
...
@Composable
fun SubscribedCollectionScreen(
    modifier: Modifier = Modifier,
    lazyGridState: LazyGridState = rememberLazyGridState(),
    active: Boolean = true,
    activationSerial: Long = 0L,
    refreshSerial: Long = 0L,
    favoriteViewModel: SubscribedCollectionViewModel = koinViewModel(),
    ...
    fun getQueryState(folderId: Long): SubscribedCollectionQueryState {
        return folderQueryStates.getOrPut(folderId) { SubscribedCollectionQueryState() }
    }
    ...
    fun activateFolderByClick(folderMetadata: SubscribedCollectionMetadata) {
    ...
    fun activateFolderForSearchAction(folderMetadata: SubscribedCollectionMetadata) {
        val folderId = folderMetadata.id
        favoriteViewModel.onFolderClicked(folderId)
