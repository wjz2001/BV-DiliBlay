...
enum class PlaySpeedItem(private val strRes: Int, val speed: Float) {
    x0_5(R.string.play_speed_x0_5, 0.5f),
    x1(R.string.play_speed_x1, 1f),
    x1_25(R.string.play_speed_x1_25, 1.25f),
    x1_5(R.string.play_speed_x1_5, 1.5f),
    x2(R.string.play_speed_x2, 2f);
