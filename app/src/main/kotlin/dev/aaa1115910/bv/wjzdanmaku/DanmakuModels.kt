...
import dev.aaa1115910.bv.wjzdanmaku.core.DanmakuCoreItem
import dev.aaa1115910.bv.wjzdanmaku.core.DanmakuCoreLocation
import dev.aaa1115910.bv.wjzdanmaku.core.DanmakuTimeRange
...
class DanmakuHostState(
    ...
    var currentPositionMs by mutableLongStateOf(currentPositionMs)
    var playbackSpeed by mutableFloatStateOf(playbackSpeed)
